...
public class ProductDAO {
    ...
    // ★ 検索（お気に入り状態も取得する）
    // ================================
    public List<Product> search(String keyword, String category, List<String> excludeAllergens, int userId) {
        ...
        sql.append("""
            SELECT 
                ...
                p.NAME, 
                p.CATEGORY,
                CASE WHEN f.USER_ID IS NOT NULL THEN 1 ELSE 0 END AS FAVORITED
            FROM PRODUCTS p
        ...
        try (Connection conn = DBUtil.getConnection();
            ...
            while (rs.next()) {
                ...
                // ★ お気に入り状態
                p.setFavorited(rs.getInt("FAVORITED") == 1);
